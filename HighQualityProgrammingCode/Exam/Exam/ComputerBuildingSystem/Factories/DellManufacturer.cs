namespace ComputerBuildingSystem.Factories
{
    ...
    public class DellManufacturer : ComputersFactory
    {
        public const int InitialPcRam = 8;
        public const int InitialPcCores = 4;
        public const int InitialPcCpuBits = 64;
        public const bool InitialPcHardDriveInRaid = false;
        public const int InitialPcHardDriveSpace = 1000;

        public const int InitialLaptopRam = 8;
        public const int InitialLaptopCores = 4;
        public const int InitialLaptopCpuBits = 32;
        public const bool InitialLaptopHardDriveInRaid = false;
        public const int InitialLaptopHardDriveSpace = 1000;

        public const int InitialServerRam = 64;
        public const int InitialServerCores = 8;
        public const int InitialServerCpuBits = 64;
        public const bool InitialServerHardDriveInRaid = true;
        public const int InitialServerHardDriveSpace = 2000;
        ...
        public override IChargeable CreateLaptop()
        {
            ...
            VideoCardBase videoCard = new ColorfulVideoCard();
            ICpu cpu = new Cpu(InitialLaptopCores, InitialLaptopCpuBits, ram, videoCard, new Cpu32BitsSquareNumberFinder());
            IEnumerable<HardDrive> hardDrives = new[]
                    {
        ...
        public override IProcessable CreateServer()
        {
            ...
            ICpu cpu = new Cpu(InitialServerCores, InitialServerCpuBits, ram, videoCard, new Cpu64BitsSquareNumberFinder());
